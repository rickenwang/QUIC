...
public class MainActivity extends AppCompatActivity {
    ...
    public void onUploadClick(View view) {
        ...
        String localPath = Environment.getExternalStorageDirectory().getAbsolutePath().concat("/30M.txt");
        try {
            createFile(localPath, 30 * 1024 * 1024);
        } catch (IOException e) {
            e.printStackTrace();
        }
        String bucket = "video-quic-upload-1251524319"; // 上传的 bucket 名称，region 为之前设置的 ap-guangzhou
        String cosPath = "30M.txt"; // 上传到 COS 的对象地址
    ...
    public void upload(String bucket, String cosPath, String localPath) {
        ...
        cosxmlUploadTask.setCosXmlProgressListener(new CosXmlProgressListener() {
            ...
            public void onProgress(final long complete, final long target) {
                // TODO: 2018/10/22
                Log.i("COSQUIC", "complete = " + complete + ", target = " + target);
            }
        });
        ...
        cosxmlUploadTask.setCosXmlResultListener(new CosXmlResultListener() {
            ...
            public void onSuccess(CosXmlRequest request, CosXmlResult result) {
                // TODO: 2018/10/22
                Log.i("COSQUIC", "upload success");
            }

            @Override
            public void onFail(CosXmlRequest request, CosXmlClientException exception, CosXmlServiceException serviceException) {
                // TODO: 2018/10/22
                Log.i("COSQUIC", "upload failed");
                Log.e("COSQUIC", "client exception " + (exception != null ? exception.getMessage() : "null"));
                Log.e("COSQUIC", "service exception " + (serviceException != null ? serviceException.getMessage() : "null"));
            }
        });
    }
    ...
    private void initCosService() {
        ...
        QCloudCredentialProvider credentialProvider = new ShortTimeCredentialProvider(secretId, secretKey, 6000);
